...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency "chef-winrm", ">= 2.4.4", "< 3.0" # This version supports Ruby 3.4
  spec.add_dependency "chef-winrm-elevated", ">= 1.2.5", "< 2.0"
  spec.add_dependency "chef-winrm-fs", ">= 1.4.1", "< 2.0" # This version supports Ruby 3.4
